...
Eigen::MatrixXf invKin(dkin &frame){
    ...
    std::cout << "--------------" << std::endl;
    std::cout << t60.determinant() << std::endl;
    std::cout << "--------------" << std::endl;
    ...
    std::cout << acos((pow(p41xz_1,2)-pow(a(1),2)-pow(a(2),2))/(2*a(1)*a(2))) << std::endl;
